...
export const directory: DirectoryConfig = {
  siteName: "Boomverzorgers Antwerpen",
  siteDescription:
    "Boomverzorgers en boomchirurgen in en rond Antwerpen, met werkgebied, specialisatie en contactgegevens.",
  siteUrl: "https://boomverzorgersantwerpen.be",
  locale: "nl-BE",

  directoryName: "Boomverzorgers Antwerpen",
  listing: {
    singular: "Boomverzorger",
    plural: "Boomverzorgers",
    singularLower: "boomverzorger",
    pluralLower: "boomverzorgers",
  },

  // Eén land: de gids dekt Antwerpen en omgeving, dus het landfilter staat
  // voorgevuld in plaats van leeg.
  defaultCountry: "België",

  primaryCta: { label: "Vind een boomverzorger", href: "/directory" },
  nav: [
    { label: "Overzicht", href: "/directory" },
    { label: "Categorieën", href: "/categories" },
  ],
  footerNav: [
    { label: "Overzicht", href: "/directory" },
    { label: "Categorieën", href: "/categories" },
    // Bewust entiteit-neutraal: een label als "Boomverzorger aanmelden"
    // blijft de oude naam dragen zodra `listing.singular` verandert.
    { label: "Bedrijf aanmelden", href: "/suggest" },
  ],
  ...
  contactEmail: "info@boomverzorgersantwerpen.be",
  ...
  features: {
    search: true,
    locations: true,
    // Boomverzorging wordt per opdracht geoffreerd; er zijn geen
    // gepubliceerde tarieven om te tonen.
    pricing: false,
    prosCons: true,
    claims: true,
    suggestions: true,
